/*
 * 8x8 bitmap font for ASCII 32-126. One byte per row, MSB = left pixel.
 * Public-domain style (VGA/classic 8x8).
 */
#include "font_8x8.h"

const uint8_t font_8x8[128][8] = {
    /* 0-31: control chars (zeros) */
    ...
    /* 48 0 */      { 0x3E, 0x63, 0x73, 0x6B, 0x67, 0x63, 0x3E, 0x00 },
    /* 49 1 */      { 0x0C, 0x1C, 0x0C, 0x0C, 0x0C, 0x0C, 0x3F, 0x00 },
    ...
    /* 85 U */      { 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x00 },
    ...
    /* 95 _ */      { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x00 },
    /* 96 ` */      { 0x0C, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00 },
    /* 97 a */      { 0x00, 0x00, 0x1E, 0x30, 0x3E, 0x33, 0x6E, 0x00 },
    /* 98 b */      { 0x07, 0x06, 0x1E, 0x36, 0x66, 0x36, 0x1E, 0x00 },
    ...
    /* 119 w */     { 0x00, 0x00, 0x63, 0x6B, 0x6B, 0x7F, 0x36, 0x00 },
